...
from .linguistic_parser import LinguisticParser, LinguisticEvidenceBundle
from .intent_resolver import IntentResolver, IntentResolution
...
class IntentEngine:
    """Integra el análisis lingüístico y la resolución de intención (Motor de Intenciones)."""
