...
from src.infrastructure import load_normalizer_config, load_json, TextNormalizer, PhraseMatcherService
...
def main() -> None:
    ...
    catalog_path = ROOT / "resources" / "phrase_matcher" / "catalog.json"
    
    try:
        normalizer_config = load_normalizer_config(normalizer_path)
